...
export const KEYWORD_DEFS: Record<string, string> = {
  ...
  'Inspire':       'As long as one or more permanents with Inspire are in the encounter under your control, you are Inspired. (An Inspired player has +1 Willpower. Inspired does not stack.)',
